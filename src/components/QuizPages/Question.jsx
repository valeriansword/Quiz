    ...
    <>
        ...
        <div className="w-full">
            ...
            <div className="flex justify-between">
                <button className={`${questionNo>1?" block ":" hidden "} text-Darkblue ring-2 
                ring-Yellow bg-Yellow rounded-md text-lg font-semibold mt-[20px] px-2 w-[20%] max-sm:w-[30%]`}
                onClick={()=>handlePrevious()}>Previous</button>
                {questionNo<=19?
                      <button className="text-Darkblue ring-2 ring-Yellow bg-Yellow rounded-md text-lg
                       font-semibold mt-[20px] px-2 w-[20%]" 
                      onClick={()=>handleNext()}>Next</button>

                :<Link to={`/SkillCentra/Quiz/levels/submission/${levelId}/${domainId}`} className="w-full flex justify-end">
                    <button className="text-Darkblue ring-2 ring-Yellow bg-Yellow rounded-md text-lg 
                    font-semibold mt-[20px] px-2 w-[20%] max-sm:w-[30%]" 
                >Submit</button></Link>}
